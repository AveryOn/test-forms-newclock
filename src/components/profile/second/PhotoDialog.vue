  ...
  <v-card color="white">
    ...
    <v-card-text class="pt-0">
      <div class="mt-2 d-flex flex-wrap">
        <template
          v-for="(photo, index) in newGalleryImg"
          :key="index"
          class="d-flex"
        >
          <v-card class="pa-0" flat>
            <ImageInputSelect
              removable
              v-if="newGalleryImg[index].img"
              v-model="newGalleryImg[index].img"
            >
            </ImageInputSelect>
            <!-- <v-text-field
                density="compact"
            ...
            <div class="d-flex">
              <input
                placeholder="Место"
                v-if="newGalleryImg[index].img"
                v-model="newGalleryImg[index].address"
                type="text"
        ...
        <div>
          <ImageInputSelect
            removable
            class="ml-2"
            v-if="firstNullAttachmentIndex !== -1"
    ...
    <v-card-text class="d-flex pb-5">
      ...
      <v-btn color="primary" class="ml-4 text-none" @click="addedetGallery"
...
import ImageInputSelect from "../../../components/ImageInputs/ImageInputSelect.vue";
