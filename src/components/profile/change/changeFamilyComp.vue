        ...
        <v-card class="d-flex flex-column pa-3 pb-0 rounded-lg">
            <v-form class="text-left" ref="refForm" lazy-validation>
                <v-card-item>
                    ...
                    <v-autocomplete autocomplete="off" required readonly="" density="default" color="primary"
                        :items="usersData" return-object label="Введите имя родственника" variant="outlined"
                        :hide-details="true" :menu-props="{
